      ...
      <div className='container'>
        <div className='row items-center justify-between'>
              ...
              <div className='w-1/2 px-3'>
                <div className="bg-white max-w-[248px] w-full h-[188px] flex justify-center items-center rounded-lg flex-col">
                  <Image
                    ...
                    alt='application'
                  />
                  <h4 className='font-medium text-xl leading-6 text-center max-w-[197px] pt-4'>Required documentation</h4>
                </div>
                <div className="bg-white max-w-[248px] w-full h-[188px] flex justify-center items-center rounded-lg flex-col mt-9">
                  <Image
                    ...
                    alt='application'
                  />
                  <h4 className='font-medium text-xl leading-6 text-center max-w-[197px] pt-4'>Visa fees and processing times</h4>
                </div>
              </div>
            </div>
          </div>
          <div className='lg:w-1/2 px-3 max-w-[473px] flex justify-end flex-col'>
            ...
            <Paragraph textName='This code standardizes procedures for short-stay visas in the Schengen Area. Herberts understanding of the Visa-Kodex ensures accurate information on: ' className='pt-4' />
